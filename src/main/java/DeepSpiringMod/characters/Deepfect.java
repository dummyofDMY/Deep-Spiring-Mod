package DeepSpiringMod.characters;
...
public class Deepfect extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    private static final String MY_CHARACTER_SHOULDER_1 = "images/characters/defect/shoulder.png";
    // 火堆的人物立绘（行动后）
    private static final String MY_CHARACTER_SHOULDER_2 = "images/characters/defect/shoulder2.png";
    // 人物死亡图像
    private static final String CORPSE_IMAGE = "images/characters/defect/corpse.png";
    // 战斗界面左下角能量图标的每个图层
    ...
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString("DeepSpiringMod:Deepfect");

    public Deepfect(String name, PlayerClass setClass) {
        super(name, setClass, ORB_TEXTURES, "images/ui/topPanel/energyBlueVFX.png", LAYER_SPEED, null, null);
    ...
    public AbstractCard.CardColor getCardColor() {
        return PlayerColorEnum.DEEP_BLUE;
    }

    // 翻牌事件出现的你的职业牌（一般设为打击）
    @Override
    public AbstractCard getStartCardForEvent() {
        return new Strike_DeepBlue();
    }

    // 卡牌轨迹颜色
    @Override
    public Color getCardTrailColor() {
        return DeepSpiringMod.MY_COLOR;
    }
    ...
    // 创建人物实例，照抄，记得替换Deepfect为你的类名
    @Override
    public AbstractPlayer newInstance() {
        return new Deepfect(this.name, PlayerColorEnum.Deepfect);
    }
    ...
    // // 注意此处是在 Deepfect 类内部的静态嵌套类中定义的新枚举值
    // // 不可将该定义放在外部的 Deepfect 类中，具体原因见《高级技巧 / 01 - Patch / SpireEnum》
    ...
    //     // 这个变量未被使用（呈现灰色）是正常的
    //     @SpireEnum
    //     public static CardLibrary.LibraryType DEEP_BLUE;
    // }
}
