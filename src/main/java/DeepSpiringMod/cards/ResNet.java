...
public class ResNet extends CustomCard {
    public static final String ID = ModHelper.makePath("ResNet");
    ...
    public static final Logger logger = LogManager.getLogger(ResNet.class);
