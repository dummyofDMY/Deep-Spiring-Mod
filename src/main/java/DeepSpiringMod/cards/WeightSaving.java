...
public class WeightSaving extends CustomCard {
    ...
    public WeightSaving() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        logger.info("Start to init WeightSaving.(no uuid)");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        // logger.info("Using WeightSaving. AP: " + AP_amount + ", Overfitting: " + Overfitting_amount + ", uuid: " + this.pre_train_card_uuid + ".");

        if (!this.upgraded) {
            AP_amount = (int)Math.floor(AP_amount * 0.5);
            Overfitting_amount = (int)Math.floor(Overfitting_amount * 0.5);
        } else {
            AP_amount = (int)Math.floor(AP_amount * 1);
            Overfitting_amount = (int)Math.floor(Overfitting_amount * 1);
        }
        ...
        this.addToBot(new SetPretrainWeightAction(AP_amount, Overfitting_amount));
        ...
        //             logger.info("Updated master deck during WeightSaving use. AP_amount: " + AP_amount + ", Overfitting_amount: " + Overfitting_amount + ", uuid: " + c.uuid + ".");
        //             break;
        //         } else {
        ...
        //         ((PreTrainedModel)c).misc = AP_amount + Overfitting_amount * 100; // 将AP和Overfitting的值编码到misc中，以便在卡牌初始化时恢复
        //         c.initializeDescription();
        //         logger.info("Updated exhaust pile during WeightSaving use. AP_amount: " + AP_amount + ", Overfitting_amount: " + Overfitting_amount + ", uuid: " + c.uuid + ".");
        //         break;
        //     }
        // }
        ...
        //         c.initializeDescription();
        //         logger.info("Updated discard pile during WeightSaving use. AP_amount: " + AP_amount + ", Overfitting_amount: " + Overfitting_amount + ", uuid: " + c.uuid + ".");
        //         break;
        //     }
        // }
        ...
        //         ((PreTrainedModel)c).misc = AP_amount + Overfitting_amount * 100;
        //         c.initializeDescription();
        //         logger.info("Updated draw pile during WeightSaving use. AP_amount: " + AP_amount + ", Overfitting_amount: " + Overfitting_amount + ", uuid: " + c.uuid + ".");
        //         break;
        //     }
        // }
        ...
        //         ((PreTrainedModel)c).misc = AP_amount + Overfitting_amount * 100;
        //         c.initializeDescription();
        //         logger.info("Updated hand during WeightSaving use. AP_amount: " + AP_amount + ", Overfitting_amount: " + Overfitting_amount + ", uuid: " + c.uuid + ".");
        //         break;
        //     }
        // }
    }
