...
public class Strike_DeepBlue extends CustomCard {
    ...
    private static final String IMG_PATH = "DeepSpiringModResources/img/cards/strike.png";
    ...
    public Strike_DeepBlue() {
        ...
        logger.info("Start to init Strike_DeepBlue.\n");
        this.damage = this.baseDamage = 6;
        this.tags.add(CardTags.STARTER_STRIKE);
        this.tags.add(CardTags.STRIKE);
        logger.info("Strike_DeepBlue initialization completed.\n");
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, damage, DamageType.NORMAL), AttackEffect.BLUNT_LIGHT));
    }
