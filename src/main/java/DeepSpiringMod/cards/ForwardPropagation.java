...
public class ForwardPropagation extends CustomCard {
    ...
    private static final String IMG_PATH = "DeepSpiringModResources/img/cards/ForwardPropagation.png";
    ...
    public ForwardPropagation() {
        ...
        // logger.info("Start to init ForwardPropagation.\n");
        // logger.info("ForwardPropagation initialization completed.\n");
