...
public class LongTraining extends CustomCard {
    public static final String ID = ModHelper.makePath("LongTraining");
    ...
    public static final Logger logger = LogManager.getLogger(LongTraining.class);
