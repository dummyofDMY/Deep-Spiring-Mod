...
public class DeepNetwork extends CustomCard {
	public static final String ID = ModHelper.makePath("DeepNetwork");
	...
	private static final String IMG_PATH = "DeepSpiringModResources/img/cards/DeepNetwork.png";
	...
	public static final Logger logger = LogManager.getLogger(DeepNetwork.class);

	public DeepNetwork() {
		// 为了命名规范修改了变量名。这些参数具体的作用见下方
		super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
		// logger.info("Start to init DeepNetwork.\n");`
		this.block = 15;
		this.baseBlock = this.block;
        this.magicNumber = this.baseMagicNumber = 3;
		this.tags.add(CardTags.STARTER_DEFEND);
		// logger.info("DeepNetwork initialization completed.\n");
	}
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new OverfittingPower(p, this.magicNumber), this.magicNumber));
