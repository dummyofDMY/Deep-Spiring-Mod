...
public class RecursionDepthPower extends AbstractPower {
    // 能力的ID
    ...
    public RecursionDepthPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        // // 添加一大一小两张能力图
        String path128 = ModHelper.makeImagePath("powers/RecursionDepth84.png");
        String path48 = ModHelper.makeImagePath("powers/RecursionDepth32.png");
